...
function Customize2() {
    ...
    return (
        <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] relative '>
            <MdKeyboardBackspace className='absolute top-[30px] left-[30px] text-white cursor-pointer w-[25px] h-[25px] transition-transform duration-200 hover:scale-110 hover:text-blue-400' onClick={() => navigate("/customize")} />
            ...
            {assistantName && <button className='min-w-[300px] h-[60px] mt-[30px] text-black font-semibold cursor-pointer bg-white rounded-full text-[19px] transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-white/30 disabled:hover:scale-100 disabled:hover:shadow-none disabled:opacity-70' disabled={loading} onClick={() => {
